...
import { Transaction } from "@/app/(protected)/account/[accountId]/page";
import { db } from "@/lib/db/prisma";
import { subDays } from "date-fns";

const ACCOUNT_ID = "ed0a7aaf-7513-4ff3-8f8f-e8e40f757437";
// const USER_ID = "user_2zAwg5CyJzSZnBT1gNl66NPSRUW";
  ...
  try {
    ...
    for (let i = 90; i >= 0; i--) {
      ...
      for (let j = 0; j < transactionsPerDay; j++) {
        ...
        totalBalance += type === "credit" ? amount : -amount;
