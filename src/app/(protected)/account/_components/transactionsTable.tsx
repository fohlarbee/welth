...
export function TransactionTable({ transactions, accountId }: {transactions: Transaction[], accountId: string}) {
  ...
  const handleBulkDelete = async () => {
    ...
    deleteFn(selectedIds, accountId );
  };
...
const handlePageChange: HandlePageChangeFn = (newPage) => {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Transactions Table */}
      <div className="rounded-md border-sidebar-border">
        <Table>
          <TableHeader>
          ...
          <TableBody>
            {paginatedTransactions.length === 0 ? (
              ...
              paginatedTransactions.map((transaction) => (
                <TableRow key={transaction.id} className="border-sidebar-border">
                  <TableCell>
                    <Checkbox
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <div className="text-sm">
                              <div className="font-medium">Date Occured:</div>
                              <div>
                                {format(
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                          ...
                          onClick={() => deleteFn([transaction.id], accountId)}
                        >
                          Delete
                        </DropdownMenuItem>
                      </DropdownMenuContent>
